...
DEFAULT_MODEL_SAVEFILE = "saved_models/door_opener_1"
DEFAULT_MODEL_LOADFILE = "saved_models/door_opener_1"
...
def create_network(session, available_actions_count):
    ...
    fc1 = tf.contrib.layers.fully_connected(conv2_flat, num_outputs=80, activation_fn=tf.nn.relu,
